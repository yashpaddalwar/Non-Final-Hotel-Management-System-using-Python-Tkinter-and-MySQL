...
class HotelManagementSystem:
    def __init__(self,root):
        ...
        room_btn = Button(btn_frame,text="ROOM",width=22,font=("times new roman",14,"bold"),bg="black",fg="white",bd=0,relief=RIDGE,cursor="hand2")
        room_btn.grid(row=1,column=0,pady=1)

        details_btn = Button(btn_frame,text="DETAILS",width=22,font=("times new roman",14,"bold"),bg="black",fg="white",bd=0,relief=RIDGE,cursor="hand2")
        ...
        logout_btn = Button(btn_frame,text="LOGOUT",width=22,font=("times new roman",14,"bold"),bg="black",fg="white",bd=0,relief=RIDGE,cursor="hand2")
    ...
    def cust_details(self):                           # Function to open customer window
