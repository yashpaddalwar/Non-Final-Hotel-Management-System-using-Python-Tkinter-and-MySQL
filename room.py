...
class Roombooking:
    def __init__(self,root):
        ...
        # Cust_Contact
        lbl_contact = Label(labelframeleft,text="Customer Contact",font=("times new roman",12,"bold"),padx=2,pady=6)
        ...
        txtSubTotal = ttk.Entry(labelframeleft,textvariable=self.var_actualtotal,width=29,font=("times new roman",13,"bold"))
        ...
        #    """""""""""""""""""""""Bill Button""""""""""""""""""""""""
        buttonBill = Button(labelframeleft,text="Bill",command=self.total,font=("times new roman",11,"bold"),bg="black",fg="white",width=10,cursor="hand2")
        buttonBill.grid(row=10,column=0,padx=1,sticky=W)


        #    """""""""""""""""""""""Buttons""""""""""""""""""""""""

        buttonAdd = Button(btn_frame,text="Add",command=self.add_data,font=("times new roman",11,"bold"),bg="black",fg="white",width=10,cursor="hand2")
        buttonAdd.grid(row=0,column=0,padx=1)

        buttonUpdate = Button(btn_frame,text="Update",command=self.update,font=("times new roman",11,"bold"),bg="black",fg="white",width=10,cursor="hand2")
        buttonUpdate.grid(row=0,column=1,padx=1)

        buttonDelete = Button(btn_frame,text="Delete",command=self.delete,font=("times new roman",11,"bold"),bg="black",fg="white",width=10,cursor="hand2")
        buttonDelete.grid(row=0,column=2,padx=1)

        buttonReset = Button(btn_frame,text="Reset",command=self.reset,font=("times new roman",11,"bold"),bg="black",fg="white",width=10,cursor="hand2")
    ...
    def update(self):
        if self.var_contact.get()=="":
            ...
            conn = mysql.connector.connect(host="localhost",username="root",password="yash2001",database="management")
            my_cursor = conn.cursor()
            my_cursor.execute("update room set Contact = %s, check_in = %s, check_out = %s, roomtype = %s, meal = %s, noOfdays = %s where roomavailable = %s",( 
                                                        self.var_contact.get(),
                                                        self.var_checkindate.get(),
                                                        self.var_checkoutdate.get(),
                                                        self.var_roomtype.get(),
